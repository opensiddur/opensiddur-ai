"""Align OSP haggadah sections to 1822 Heidenheim printed page numbers."""
...
def _normalize_hebrew(text: str) -> str:
    return re.sub(r"[^\u05d0-\u05ea]", "", _strip_marks(text))
...
def write_page_breaks(
    ...
    payload = {
        "_comment": (
            ...
            "Generated by align_page_breaks.py from the 1822 PDF facsimile."
        ),
        **mapping,
    }
