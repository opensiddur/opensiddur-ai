...
| **total** | **1008** | **14** | **9** | **51** | **0** |

**No misreading survives in 1008 words.** But the second number in that column has grown
...
reliable *for consonants* — the skeleton has not been wrong once in 1008 words. It is not
