...
| **total** | **1338** | **21** | **15** | **61** | **0** |

**No misreading survives in 1338 words.** But the second number in that column has grown
...
reliable *for consonants* — the skeleton has not been wrong once in 1338 words. It is not
