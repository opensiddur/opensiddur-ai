...
| **total** | **1196** | **21** | **10** | **57** | **0** |

**No misreading survives in 1196 words.** But the second number in that column has grown
faster than the first, and it is now the one that matters: **eighteen readings have been
...
reliable *for consonants* — the skeleton has not been wrong once in 1196 words. It is not
