...
poetry run python opensiddur/converters/util/xslt.py -o schema/jlptei.odd.xml.schematron.xslt scripts/schxslt2/transpile.xsl schema/jlptei.odd.xml.schematron